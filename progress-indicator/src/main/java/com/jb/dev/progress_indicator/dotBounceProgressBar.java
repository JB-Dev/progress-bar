...
public class dotBounceProgressBar extends LinearLayout {
    ...
    public dotBounceProgressBar(Context context) {
        super(context);
    }

    public dotBounceProgressBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public dotBounceProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
