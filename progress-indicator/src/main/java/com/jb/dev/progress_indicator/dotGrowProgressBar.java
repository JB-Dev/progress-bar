...
public class dotGrowProgressBar extends LinearLayout {
    ...
    public dotGrowProgressBar(Context context) {
        super(context);
    }

    public dotGrowProgressBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public dotGrowProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
