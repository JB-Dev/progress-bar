...
public class fadeProgressBar extends LinearLayout {
    ...
    public fadeProgressBar(Context context) {
        super(context);
    }

    public fadeProgressBar(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public fadeProgressBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
